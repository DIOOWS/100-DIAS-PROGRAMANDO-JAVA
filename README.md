...
| Dia   | Desafio                                                                 |
|-------|-------------------------------------------------------------------------|
| 1     | Criar uma calculadora simples (somar, subtrair, multiplicar, dividir). |
...
| 7     | Jogo de adivinhar números (número aleatório gerado pelo computador).    |
| 8     | Programa para calcular IMC e classificar o resultado.                  |
| 9     | Cronômetro simples (contagem regressiva de segundos).                   |
| 10    | Conversor de temperatura (Celsius ↔ Fahrenheit).                        |
...
## Dias 31 a 60: Projetos Intermediários com Orientação a Objetos
...
## Dias 61 a 100: Introdução ao Spring Boot e Projetos Avançados
